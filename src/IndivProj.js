...
export const IndivProj = () => {
    ...
    return (
        <div style={{backgroundColor:'#282c34', height:'2000px', color:'white', marginTop:'35px'}}>
            <br></br>
            ...
            <br></br>
            <h2>This project seeks to raise awareness for the deforestation and protect forests.</h2>
            <br></br>
            <hr></hr>
...
A tonne of CO₂ has the same impact on the climate whether it comes from fossil fuels or forest loss, so halting deforestation is a necessary part of tackling climate change. ... The amount of warming is tightly linked to the amount of CO₂ in the atmosphere.</h3>
            <br></br>
            <hr></hr>
            <br></br>
            <h2 style={{color:'#ffc107'}}>Price: 0.5ETH</h2>
            <br></br>
            <hr></hr>
            <h2 style={{color:'#ffc107'}}>NFTs available</h2>
            <div style={{height:'300px'}}>this is a placeholder to put NFTs, i think we dont need a modal to show it because this page would be too empty :oo</div>
            <hr></hr>
            <br></br>
