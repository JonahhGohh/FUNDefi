    ...
    return (
        <div>
            <header className="App-header">
                <h1 style={{marginTop: '60px', color: 'white' }}>Discover Fundraisers</h1>
                <h3 style={{marginTop: '10px', marginBottom: '35px', width: '900px', color: 'cyan' }}>You can make a difference now!</h3>
                ...
                <Card className="rounded-3 my-3 mx-3 py-3 px-3" style={{color: "#000"}}>
                    ...
                    <Card.Footer className="text-muted">Started 28 days ago</Card.Footer>
                </Card>
                </CardGroup>  

                {/*Card#4 - Preserve arts*/}
                <CardGroup>
                <Card className="rounded-3 my-5 mx-3 py-3 px-3" style={{color: "#000"}}>
                    <ProgressBar className='progress4 bg-success' role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"><span>45% complete</span></ProgressBar>
                    <Card.Header>PRESERVE OUR ARTS</Card.Header>
                    <Card.Img className='photo' src={require('./images/art.jpg')}/>
                    <Card.Body>
                    <Card.Title>180 USD</Card.Title>
                    <Card.Text className="border d-flex align-items-center justify-content-center">This project aims to raise awareness and preserve new artists by providing exhibition spaces to showcase their work.</Card.Text>
                    <Button className="mx-1 py-3 px-3" variant="dark" size="lg">Find out more</Button>
                    <Button className="mx-1 py-3 px-3" variant="primary" size="lg">Donate now</Button>
                    </Card.Body>
                ...
                <Card className="rounded-3 my-5 mx-3 py-3 px-3" style={{color: "#000"}}>
                    <ProgressBar className='progress5 bg-success' role="progressbar" aria-valuenow="93" aria-valuemin="0" aria-valuemax="100"><span>93% complete</span></ProgressBar>
                    <Card.Header>LOW-INCOME FAMILIES</Card.Header>
                    <Card.Img className='photo' src={require('./images/food.jpg')}/>
                    <Card.Body>
                    <Card.Title>90 USD</Card.Title>
                    <Card.Text className="border d-flex align-items-center justify-content-center">This goal of this project is to raise 50K USD to provide food and groceries to low-income families in Singapore.</Card.Text>
                    <Button className="mx-1 py-3 px-3" variant="dark" size="lg">Find out more</Button>
                    <Button className="mx-1 py-3 px-3" variant="primary" size="lg">Donate now</Button>
                    </Card.Body>
                    <Card.Footer className="text-muted">Started 41 days ago</Card.Footer>
                </Card>
                
                {/*Card#6 - support cancer patients*/}
                <Card className="rounded-3 my-5 mx-3 py-3 px-3" style={{color: "#000"}}>
                    <ProgressBar className='progress6 bg-success' role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"><span>55% complete</span></ProgressBar>
                    <Card.Header>SUPPORT CANCER PATIENTS</Card.Header>
                    <Card.Img className='photo' src={require('./images/cancer.jpg')}/>
                    <Card.Body>
                    <Card.Title>210 USD</Card.Title>
                    <Card.Text className="border d-flex align-items-center justify-content-center">This project aims to raise USD$500,000 to fund medical treatments and chemotherapy for cancer patients in the US.</Card.Text>
                    <Button className="mx-1 py-3 px-3" variant="dark" size="lg">Find out more</Button>
                    <Button className="mx-1 py-3 px-3" variant="primary" size="lg">Donate now</Button>
                    </Card.Body>
                    <Card.Footer className="text-muted">Started 34 days ago</Card.Footer>
                </Card>
                </CardGroup> 
           </header>
        </div >
